...
public class FauxProductRepository {
    ...
    public Product getProductById(String searchId) {
        ...
        fauxProductDb.add(new Product("prod2", "Price is the same - no red pencil", 20.00, LocalDate.of(2019, 04, 12), false, 20.00, null));
        ...
        fauxProductDb.add(new Product("prod4", "Current red pencil sale with a price increase", 40.00,  LocalDate.of(2018, 12, 31), true, 10.00,LocalDate.now().minusDays(5)));
        fauxProductDb.add(new Product("prod5", "Price dropped outside of range", 69.00,  LocalDate.of(2018, 12, 31), false, 100.00,null));
        fauxProductDb.add(new Product("prod6", "Price meets criteria", 40.00,  LocalDate.of(2018, 12, 31), false, 50.00,null));
